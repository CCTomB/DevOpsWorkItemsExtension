...
- The pipeline accepts `repositoryName` and `repositoryProjectId` parameters. Enter the Azure Repos repository name and the project ID containing that repository; this project can differ from the project containing the selected work items and pipeline.
