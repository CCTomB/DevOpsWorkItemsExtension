...
- The pipeline accepts an optional `repositoryName` parameter. Leave it blank to use the pipeline's checkout repository, or enter the Azure Repos repository name explicitly.
